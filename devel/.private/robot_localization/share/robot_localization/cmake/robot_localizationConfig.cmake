...
if("TRUE" STREQUAL "TRUE")
  set(robot_localization_SOURCE_PREFIX /home/aaryan-atp/meloc/ekfFusion/src/robot_localization)
  set(robot_localization_DEVEL_PREFIX /home/aaryan-atp/meloc/ekfFusion/devel/.private/robot_localization)
  ...
  set(robot_localization_INSTALL_PREFIX /home/aaryan-atp/meloc/ekfFusion/install)
...
if(NOT "/home/aaryan-atp/meloc/ekfFusion/devel/.private/robot_localization/include;/home/aaryan-atp/meloc/ekfFusion/src/robot_localization/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(robot_localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/aaryan-atp/meloc/ekfFusion/devel/.private/robot_localization/include;/home/aaryan-atp/meloc/ekfFusion/src/robot_localization/include;/usr/include/eigen3;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aaryan-atp/meloc/ekfFusion/src/robot_localization/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/aaryan-atp/meloc/ekfFusion/devel/.private/robot_localization/lib;/home/aaryan-atp/meloc/ekfFusion/devel/lib;/opt/ros/noetic/lib)
